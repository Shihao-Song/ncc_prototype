...
public:
    ...
    // Edits, better to return back a reference
...
public:
    ...
    // Edits, it is better to return back a reference
    ...
    void print_connections()
    {
        ...
        for (auto &input : inEdges) { std::cout << input << " "; } std::cout << "\n";
        std::cout << "Output Neuron IDs: ";
        for (auto &output : outEdges) { std::cout << output << " "; } std::cout << "\n";
        std::cout << "\n";
    }
};
